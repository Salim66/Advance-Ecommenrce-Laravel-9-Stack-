...
<div class="span9">
    ...
    <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                <td> <img width="60" src="{{ URL::to('frontend/') }}/themes/images/products/4.jpg" alt=""/></td>
                ...
                <tr>
                <td> <img width="60" src="{{ URL::to('frontend/') }}/themes/images/products/8.jpg" alt=""/></td>
                <td>Casual T-Shirt<br/>Color : Black</td>
                <td>
                ...
                <tr>
                <td> <img width="60" src="{{ URL::to('frontend/') }}/themes/images/products/3.jpg" alt=""/></td>
